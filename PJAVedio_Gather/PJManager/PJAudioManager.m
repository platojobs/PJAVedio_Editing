...
@implementation PJAudioManager

static PJAudioManager* shareInstace = nil;
...
{
    PJAudioManager * manager = (__bridge PJAudioManager*)inUserData;
    ...
    if (nRet > 0)
    {
        [[PJRtmpManager pj_getInstance] pj_send_rtmp_audio:manager->outputBuffer andLength:nRet];
...
- (void)openEncoder
{
    ...
    [[PJRtmpManager pj_getInstance] pj_send_rtmp_audio_spec:tmp andLength:(UInt32)spec_len];
